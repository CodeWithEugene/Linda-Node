...
import { areaCentroid, initialMapPosition } from './AreaMap'
...
describe('areaCentroid', () => {
  ...
  it('centers the zoomed viewport on Kenya instead of the world origin', () => {
    expect(initialMapPosition).toEqual({ coordinates: [37.9, .2], zoom: 5 })
  })
})
